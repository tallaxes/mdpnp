# script for karaf: installs and starts bundles for shapes in clean container
...
install -s  mvn:com.rti.dds.type/shapes-type/1.0-SNAPSHOT

echo "RTI-Camel component"
install -s  mvn:com.rti.dds.camel/rti-camel/1.0-SNAPSHOT

echo "Shapes Routing"
install -s  mvn:com.rti.dds.camel.shapes/example-shapes/1.0-SNAPSHOT
