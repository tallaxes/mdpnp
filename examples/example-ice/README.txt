...
Camel RTI ICE Example
========================

This example shows basic routing for the RTI Ice Demo. 
This example will route ICE data from Topics in domain 28 to Topics in domain 29.
...
The generated bundle's info:
	com.rti.dds.camel/example-ice/1.0-SNAPSHOT
		
  
The idl for the data type used in the Ice demo can be found in the project ice-type. This project will generate an OSGi bundle for the type used by this example.  See 	the pom.xml for the dependency declaration.
